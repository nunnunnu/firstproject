...
public interface OrderInfoRepository extends JpaRepository<OrderInfoEntity, Long>{
     @Query("select o from OrderInfoEntity o join fetch o.pay join fetch o.store where o.oiSeq=:seq and o.member=:member")
     ...
     List<OrderInfoEntity> findByStoreOrderByOiOrderTimeDesc(StoreInfoEntity store);
}
